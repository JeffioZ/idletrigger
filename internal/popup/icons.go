...
const (
	appIconResourceID       = winresource.AppIconID       // Main executable icon; shared class fallback only.
	trayDarkIconResourceID  = winresource.TrayDarkIconID  // Dark mark for a light title bar.
	trayLightIconResourceID = winresource.TrayLightIconID // Light mark for a dark title bar.
)
