...
Copy the following structure into the draft release. Omit the bold labels when there are no more than three highlights.

将以下结构复制到 Release 草稿中。更新不超过 3 条时，省略粗体分组标签。
